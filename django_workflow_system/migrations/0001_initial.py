# Generated by Django 3.1.8 on 2021-05-13 12:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_group', models.ForeignKey(blank=True, default=None, help_text='Data groups can be arranged in hierarchies.', null=True, on_delete=django.db.models.deletion.CASCADE, to='django_workflow_system.workflowstepdatagroup')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='data_groups',
            field=models.ManyToManyField(blank=True, help_text='A list of data groups that this step is associated with.', to='django_workflow_system.WorkflowStepDataGroup'),
        ),
        migrations.AddField(
            model_name='workflowstep',
            name='ui_template',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='django_workflow_system.workflowcollectiontagtype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('workflow_collection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_workflow_system.workflowcollection')),
                ('workflow_collection_tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_workflow_system.workflowcollectiontagoption')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='tags',
            field=models.ManyToManyField(through='django_workflow_system.WorkflowCollectionTagAssignment', to='django_workflow_system.WorkflowCollectionTagOption'),
        ),
        migrations.CreateModel(
            name='WorkflowAuthor',
            fields=[
