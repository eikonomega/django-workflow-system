...
workflow_endpoints = [
    ...
    path('authors/<uuid:id>/', workflows.WorkflowAuthorView.as_view(), name='workflow-author'),
    path('collections/', workflows.WorkflowCollectionsView.as_view(), name='workflow-collections'),
