...
class WorkflowCollectionSubscriptionScheduleSummarySerializer(serializers.ModelSerializer):
    """
...
class WorkflowCollectionSubscriptionSummarySerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        """
        workflow_collection_subscription = WorkflowCollectionSubscription.objects.create(
            user=validated_data['user'],
            active=validated_data['active'] if validated_data.get(
                'active') else True,
        ...
        for subscription in workflowcollectionsubscriptionschedule_data:
            subscription['workflow_collection_subscription'] = workflow_collection_subscription
            WorkflowCollectionSubscriptionSchedule.objects.create(
                **subscription)
