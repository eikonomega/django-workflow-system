    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        max_length=200,
                        null=True,
                        upload_to=workflows.utils.media_files.workflow_cover_image_location,
                    ),
                ),
                (
                    "on_completion",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=200,
                        validators=[workflows.utils.validate_code.validate_code],
                    ),
                ),
                ("version", models.PositiveIntegerField(default=1)),
                ("name", models.CharField(max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        to="workflows.workflowcollection",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="workflows.workflowstepdatagroup",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.PROTECT,
                to="workflows.workflowstepuitemplate",
            ),
        ),
        migrations.AddField(
            model_name="workflowstep",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        to="workflows.workflowcollectiontagtype",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "workflow_collection_tag",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="workflows.workflowcollectiontagoption",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        to="workflows.workflowcollectionengagement",
                    ),
                ),
                (
                    "user",
        ...
        migrations.AddField(
            ...
            name="tags",
            field=models.ManyToManyField(
                through="workflows.WorkflowCollectionTagAssignment",
                to="workflows.WorkflowCollectionTagOption",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        max_length=200,
                        null=True,
                        upload_to=workflows.models.author.workflow_author_media_folder,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        max_length=200,
                        upload_to=workflows.utils.media_files.workflow_step_media_location,
                    ),
                ),
                (
                    "workflow_step",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="workflows.workflowstepdependencygroup",
                    ),
                ),
                (
                    "dependency_step",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="workflows.workflowcollectionsubscription",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        max_length=200,
                        upload_to=workflows.utils.media_files.collection_image_location,
                    ),
                ),
                (
                    "collection",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        to="workflows.workflowcollectionimagetype",
                    ),
                ),
            ],
            options={
