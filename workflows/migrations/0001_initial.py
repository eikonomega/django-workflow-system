# Generated by Django 3.1.3 on 2021-03-23 16:07
...
import uuid
import workflows.utils.media_files
import workflows.utils.validators
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text='A short-hand reference to the schema definition.', max_length=100, validators=[workflows.utils.validators.validate_code])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text='An internal code for database level operations', max_length=200, validators=[workflows.utils.validators.validate_code])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('code', models.CharField(max_length=200, validators=[workflows.utils.validators.validate_code])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('code', models.CharField(help_text='An identifier for programmatically referencing this step.', max_length=200, validators=[workflows.utils.validators.validate_code])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_group', models.ForeignKey(blank=True, default=None, help_text='Data groups can be arranged in hierarchies.', null=True, on_delete=django.db.models.deletion.CASCADE, to='workflows.workflowstepdatagroup')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='data_groups',
            field=models.ManyToManyField(blank=True, help_text='A list of data groups that this step is associated with.', to='workflows.WorkflowStepDataGroup'),
        ),
        migrations.AddField(
            model_name='workflowstep',
            name='ui_template',
            field=models.ForeignKey(help_text='The UI template associated with the step.', on_delete=django.db.models.deletion.PROTECT, to='workflows.workflowstepuitemplate'),
        ),
        migrations.AddField(
            model_name='workflowstep',
            name='workflow',
            field=models.ForeignKey(help_text='The workflow associated with the step.', on_delete=django.db.models.deletion.CASCADE, to='workflows.workflow'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='workflows.workflowcollectiontagtype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiration', models.DateField(default=datetime.date(2021, 4, 23))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(max_length=200, null=True, upload_to=workflows.utils.media_files.author_media_location)),
        ...
        migrations.AddField(
            model_name='workflow',
            name='author',
            field=models.ForeignKey(help_text='The author of the Workflow', on_delete=django.db.models.deletion.PROTECT, to='workflows.workflowauthor'),
        ),
        migrations.AddField(
            model_name='workflow',
            name='created_by',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('ui_identifier', models.CharField(max_length=200)),
                ('url', models.ImageField(max_length=200, upload_to=workflows.utils.media_files.workflow_step_media_location)),
                ('workflow_step', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='workflows.workflowstep')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('ui_identifier', models.CharField(max_length=200)),
                ('url', models.FileField(max_length=200, upload_to=workflows.utils.media_files.workflow_step_media_location)),
                ('workflow_step', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='workflows.workflowstep')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('image', models.ImageField(max_length=200, upload_to=workflows.utils.media_files.workflow_image_location)),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='workflows.workflowimagetype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('image', models.ImageField(max_length=200, upload_to=workflows.utils.media_files.collection_image_location)),
                ('collection', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='workflows.workflowcollection')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='workflows.workflowcollectionimagetype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('step', models.ForeignKey(help_text='The WorkflowStep associated with the engagement detail.', on_delete=django.db.models.deletion.PROTECT, to='workflows.workflowstep')),
                ('workflow_collection_engagement', models.ForeignKey(help_text='The WorkflowCollectionEngagement object associated with the engagement detail.', on_delete=django.db.models.deletion.PROTECT, to='workflows.workflowcollectionengagement')),
            ],
            options={
