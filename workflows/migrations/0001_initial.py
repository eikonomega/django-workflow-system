# Generated by Django 3.1.3 on 2021-03-09 22:55
...
import workflows.utils.workflow_step_media_folder
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('code', models.CharField(max_length=200, validators=[workflows.models.collection.validate_code])),
                ('version', models.PositiveIntegerField(default=1)),
                ('name', models.CharField(max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiration', models.DateField(default=datetime.date(2021, 4, 9))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('ui_identifier', models.CharField(max_length=200)),
                ('url', models.ImageField(max_length=200, upload_to=workflows.utils.workflow_step_media_folder.workflow_step_media_folder)),
                ('workflow_step', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='workflows.workflowstep')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('ui_identifier', models.CharField(max_length=200)),
                ('url', models.FileField(max_length=200, upload_to=workflows.utils.workflow_step_media_folder.workflow_step_media_folder)),
                ('workflow_step', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='workflows.workflowstep')),
            ],
            options={
