...
class WorkflowStepText(CreatedModifiedAbstractModel):
    ...
    storage_value = models.IntegerField(
        blank=True,
        null=True,
        help_text="The value that will be stored, in place of direct user input. "
                  "This is used when multiple WorkflowStepInputs are used "
                  "to represent single-choice options"
    )
